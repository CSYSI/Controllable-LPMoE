...
def cosine_similarity(query, value):
    ...
    cos_sim = torch.bmm(query_norm, value_norm.transpose(1, 2))

    weighted_value = torch.bmm(cos_sim, value)
...
class MSDeformAttn(nn.Module): # Cosine-aligned deformable attention
    ...
    def forward(self, query, reference_points, input_flatten, input_spatial_shapes,
        ...
        attention_weights = attention_weights * cosine_sim
