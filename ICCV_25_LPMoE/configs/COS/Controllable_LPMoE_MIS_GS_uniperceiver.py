...
_base_ = [
    ...
    '../_base_/datasets/mydata_MIS_GS_GS.py',
...
img_norm_cfg = dict(
    mean=[168.20,147.95,190.86], std=[55.03,56.61,37.63], to_rgb=True)
img_norm_cfg_test = dict(
    mean=[150.59, 131.38, 176.47], std=[48.13,50.08,29.49], to_rgb=True)
