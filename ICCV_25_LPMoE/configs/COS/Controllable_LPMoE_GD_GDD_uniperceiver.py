...
_base_ = [
    ...
    '../_base_/datasets/mydata_gd_GDD.py',
...
# dataset settings
img_norm_cfg = dict(
    mean=[125.39, 119.00, 110.42], std=[62.58, 60.81, 59.91], to_rgb=True)
img_norm_cfg_test = dict(
    mean=[121.96, 115.76, 107.25], std=[63.57, 62.10, 61.95], to_rgb=True)
train_pipeline = [
