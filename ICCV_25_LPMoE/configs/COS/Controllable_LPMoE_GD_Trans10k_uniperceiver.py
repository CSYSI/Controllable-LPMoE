...
_base_ = [
    ...
    '../_base_/datasets/mydata_gd_Trans10k.py',
...
# dataset settings
img_norm_cfg = dict(
    mean=[119.49, 113.97, 108.67], std=[59.97, 59.87, 60.90], to_rgb=True)
img_norm_cfg_test = dict(
    mean=[121.36, 115.01, 109.23], std=[59.93, 59.74, 60.87], to_rgb=True)
train_pipeline = [
...
evaluation = dict(interval=5000, metric=['mIoU','mFscore','mDice'], save_best='mIoU', rule='greater')
